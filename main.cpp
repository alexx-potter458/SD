...
int main()
{
    ...
    cout<<"*********************************************"<<"\n";
    cout<<"1 pentru citirea a 10 valori din fisier"<<"\n";
    cout<<"2 pentru citirea a 100 de valori din fisier"<<"\n";
    cout<<"3 pentru citirea a 10000 de valori din fisier"<<"\n";
    cout<<"4 pentru citirea a 100000 de valori din fisier"<<"\n";
    cout<<"5 pentru citirea a 500000 de valori din fisier"<<"\n"<<"\n";
    do
    {
        ...
        {
            f.open("test_10.txt" );
            g.open("text_10_output.txt", ios_base::app);
        ...
        {
           f.open("test_100.txt");
           g.open("text_100_output.txt", ios_base::app);
           cout << "Testul " << option << " a fost ales"<<"\n";
           break;
        }
        else if(option == 3)
        {
            ...
            g.open("text_10000_output.txt", ios_base::app);
            cout << "Testul " << option << " a fost ales"<<"\n";
            break;
        }
        else if(option == 4)
        {
            ...
            g.open("text_100000_output.txt", ios_base::app);
            cout << "Testul " << option << " a fost ales"<<"\n";
            break;
        }
        else if(option == 5)
        {
            ...
            g.open("text_500000_output.txt", ios_base::app);
            cout << "Testul " << option << " a fost ales"<<"\n";
            break;
        }
        else cout << "Nu ai ales corect, mai citeste o data"<<"\n";
    }
